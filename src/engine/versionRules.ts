...
export const VERIFIED_PAIRS = new Set<string>([
  ...
  "27.0:core-data-save",
  "27.0:detected-fs-antipattern",
  "27.0:display-surface-swap",
  "27.0:displayed-surfaces-interval",
  "27.0:FMEventTable",
  "27.0:fs-syscall",
  "27.0:hang-risks",
  "27.0:hitches",
  "27.0:hitches-renders",
